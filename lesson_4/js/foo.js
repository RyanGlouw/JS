...
function getAverage(...nums) { // функция принимаяет на вход переменное количество аргументов // если 3 точки то это массив собирает все аргументы
    let sum = 0;
    for (let val of nums) {
        sum += val; 
    }
...
console.log(avg);
// если функция принимает на вход несколько аргументов и есть 3 точки то ...agrument идет всегда в конце 
